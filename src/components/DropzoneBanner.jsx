...
import { ImageCropModalBanner } from "./ImageCropModalBanner";
...
export const DropzoneBanner = ({
  ...
  return (
    <Box {...props}>
      ...
      {croppable && 
        <ImageCropModalBanner target={crop} ratio={ratio} minWidth={croppable?.minWidth} setImage={append} onClose={() => setCrop(null)} />
      }
    </Box>
  );
};
